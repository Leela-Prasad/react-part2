...
const slice = createSlice({
  ...
  reducers: {
    ...
    setSearchText: (gameQuery, action) => ({searchText: action.payload.searchText} as GameQuery)
        // gameQuery = {} as GameQuery
        // gameQuery.searchText = action.payload.searchText
        
    
  },
});

export const {setGenreId, setPlatformId, setSortOrder, setSearchText } = slice.actions
